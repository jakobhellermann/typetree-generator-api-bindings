...
pub struct TypeTreeGeneratorAPI {
    ...
    pub TypeTreeGenerator_getMonoBehaviourDefinitions:
        unsafe extern "C" fn(
            handle: *mut TypeTreeGeneratorHandle,
            arr_addr: *mut *mut [*mut ::std::os::raw::c_char; 2usize],
            arr_length: *mut ::std::os::raw::c_int,
        ) -> ::std::os::raw::c_int,
    pub TypeTreeGenerator_freeMonoBehaviourDefinitions:
        unsafe extern "C" fn(
            arr_addr: *mut [*mut ::std::os::raw::c_char; 2usize],
            arr_length: ::std::os::raw::c_int,
        ) -> ::std::os::raw::c_int,
    pub TypeTreeGenerator_setAddMonoBehaviourRootNodes:
        unsafe extern "C" fn(value: ::std::os::raw::c_uchar) -> ::std::os::raw::c_int,
...
impl TypeTreeGeneratorAPI {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let TypeTreeGenerator_generateTreeNodesRaw = __library
            ...
            .map(|sym| *sym)?;
        let TypeTreeGenerator_getMonoBehaviourDefinitions = __library
            .get(b"TypeTreeGenerator_getMonoBehaviourDefinitions\0")
            .map(|sym| *sym)?;
        let TypeTreeGenerator_freeMonoBehaviourDefinitions = __library
            .get(b"TypeTreeGenerator_freeMonoBehaviourDefinitions\0")
            .map(|sym| *sym)?;
        let TypeTreeGenerator_setAddMonoBehaviourRootNodes = __library
            .get(b"TypeTreeGenerator_setAddMonoBehaviourRootNodes\0")
            .map(|sym| *sym)?;
        ...
        Ok(TypeTreeGeneratorAPI {
            ...
            TypeTreeGenerator_getMonoBehaviourDefinitions,
            TypeTreeGenerator_freeMonoBehaviourDefinitions,
            TypeTreeGenerator_setAddMonoBehaviourRootNodes,
    ...
    pub unsafe fn TypeTreeGenerator_getMonoBehaviourDefinitions(
        &self,
        handle: *mut TypeTreeGeneratorHandle,
        arr_addr: *mut *mut [*mut ::std::os::raw::c_char; 2usize],
        arr_length: *mut ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int {
        (self.TypeTreeGenerator_getMonoBehaviourDefinitions)(handle, arr_addr, arr_length)
    }
    pub unsafe fn TypeTreeGenerator_freeMonoBehaviourDefinitions(
        &self,
        arr_addr: *mut [*mut ::std::os::raw::c_char; 2usize],
        arr_length: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int {
        (self.TypeTreeGenerator_freeMonoBehaviourDefinitions)(arr_addr, arr_length)
    }
    pub unsafe fn TypeTreeGenerator_setAddMonoBehaviourRootNodes(
        &self,
        value: ::std::os::raw::c_uchar,
    ) -> ::std::os::raw::c_int {
        (self.TypeTreeGenerator_setAddMonoBehaviourRootNodes)(value)
    }
